...
基于 LLM + LangGraph + RAG 的个性化减脂/增肌 AI Agent，支持用户建档、营养计算、训练计划生成、食材图片识别、轻食菜谱生成、餐食热量识别、身材照片分析、AI 动作分析、每日打卡和 AI 复盘。
...
│  │  │  ├─ MealView.vue      # 餐食热量识别
│  │  │  ├─ BodyPhotoView.vue # 身材照片分析（Mock）
│  │  │  ├─ PoseView.vue      # AI 动作分析（Mock）
